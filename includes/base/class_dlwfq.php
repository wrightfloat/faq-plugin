...
class dlwfq_setup{
    ...
    public function setup_faq_archive_page($archive_template) {
        ...
        if( is_post_type_archive( $this->custom_post_type ) ){
            ...
            // make sure too let users know that the archive faq page must be defined as this if they add a custom archive page too there theme. 
            
            $archive_template = dlwfq_get_faq_archive_template($file_name); 
            // includes/base/dlwfq_core_function.php
