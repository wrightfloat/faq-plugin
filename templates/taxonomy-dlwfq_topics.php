    ...
    <section>
        <header class="faq-header">
            <h1 class="faq-header-title page-title">
                <?php echo esc_html( dlwfq_echo_archive_title('taxonomy') ); ?>
            </h1>
        </header>
    </section>
    ...
    <?php else: 
        ...
        ?>
        <ul id="basics" class="dlwfq-fq-list">
            <li class="dlwfq-fq-target" data-content-status="closed" data-index="1">
                <span class="dlwfq-fq-target">
                <?php 
                    //Make this editable via backend settings, Also needs documentation added too support form. 
                    esc_html_e( __('Sorry, No FAQS To Display here', 'dlwfq_faqizer') );
                ?>
                </span>
            </li>
        </ul>
